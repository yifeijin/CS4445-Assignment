...
'''
    ...
    The main goal of this problem is to get familiar with a simplified problem in reinforcement learning, and how to 
    train the model parameters on the data from a game.
   ...
   # ----------------------------------------------
    def policy(self):
        ...
        for i in range(len(self.w)):
            UCBs.append(UCBplayer.UCB(self.w[i], self.ni[i], self.N, self.c))
